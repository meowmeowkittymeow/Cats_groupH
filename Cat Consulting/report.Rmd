...
We found that there overweight cats were not more likely to have a
repeat UO. We separated the data into two weight classes under the
variable name `weight_class`. The 3rd quartile of weights of patients in
...
procedure. The number of cats who had a difficult procedure and those
who had an easy one were nearly the same. Among the two groups the
proportion of cats who had a history of UO was very similar. 12.6% of
the cats had history, and around 46% of those cats had a difficult
procedure.
...
\
Patients that experienced difficult procedures were not more likely to
...
However, we did observe a relationship between a cat's age and having
repeat urinary obstruction regardless of the procedure difficulty. Both
the median and mean age of cats who didn't have a repeat UO was lower
...
having a repeat OU. For every additional year a cat lives, it's odds of
